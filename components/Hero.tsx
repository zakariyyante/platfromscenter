...
export default function Hero() {
  ...
  return (
    <section className="relative pt-32 pb-20 px-6 overflow-hidden bg-[#010401]">
      {/* Background Gradient Effect */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full max-w-7xl bg-emerald-900/10 blur-[150px] rounded-full -z-10" />
      ...
      <div className="container mx-auto text-center relative z-10">
        ...
        <div className="flex items-center justify-center gap-6 mb-24">
          ...
          <span className="text-2xl text-emerald-500 font-light tracking-tighter">$</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          <div className="bg-white/5 border border-white/10 p-8 rounded-2xl flex items-center gap-6 text-left group hover:bg-white/[0.08] transition-all">
            <div className="w-14 h-14 rounded-2xl bg-white/5 flex items-center justify-center border border-white/10 group-hover:border-emerald-500/50 transition-colors">

      ...
      <header className="fixed top-0 z-50 w-full bg-[#010401]/95 backdrop-blur-sm border-b border-white/5">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            ...
            <nav className="hidden md:flex items-center gap-8">
              <Link href="/" className="text-xs font-bold text-white hover:text-emerald-400 transition-colors tracking-widest uppercase">Accueil</Link>
              <Link href="#brands" className="text-xs font-bold text-white hover:text-emerald-400 transition-colors tracking-widest uppercase">Classement</Link>
              <Link href="#guide" className="text-xs font-bold text-white hover:text-emerald-400 transition-colors tracking-widest uppercase">Critères</Link>
              <Link href="#about" className="text-xs font-bold text-white hover:text-emerald-400 transition-colors tracking-widest uppercase">Édition</Link>
            </nav>
          </div>
        ...
        {isOpen && (
          <div className="md:hidden bg-[#010401] border-b border-white/10 px-6 py-8 flex flex-col gap-6 animate-in slide-in-from-top duration-300">
            ...
            <Link href="#contact" onClick={() => setIsOpen(false)} className="text-sm font-bold text-emerald-400 tracking-widest">CONTACT</Link>
          </div>
        )}
      </header>
    </>

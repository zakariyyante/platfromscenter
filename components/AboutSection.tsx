        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <div className="glass-morphism cyber-border p-10 rounded-sm">
            <h3 className="text-2xl font-black mb-8 text-white uppercase tracking-tight flex items-center gap-4">
              <span className="text-emerald-400">01.</span> AUDIT DE PERFORMANCE
            </h3>
            <ul className="space-y-6">
              {[
                ...
                "Protocole de scoring propriétaire Platforms Portal"
              ].map((item, i) => (
          ...
          <div className="glass-morphism cyber-border p-10 rounded-sm border-l-emerald-500/50">
            <h3 className="text-2xl font-black mb-8 text-white uppercase tracking-tight flex items-center gap-4">
              <span className="text-emerald-400">02.</span> UTILISATION RESPONSABLE
            </h3>
            ...
            <div className="space-y-6">
              ...
              >
                <div className="flex flex-col">
                  <span className="text-[10px] text-emerald-400 uppercase tracking-widest mb-1">Aide Immédiate</span>
                  <span className="font-bold text-white text-lg tracking-tighter">09 74 75 13 13</span>
                </div>
                <span className="text-emerald-400 font-black text-sm group-hover:translate-x-2 transition-transform uppercase tracking-widest">INFO SERVICE →</span>
              </a>
            </div>
          </div>
        </div>
